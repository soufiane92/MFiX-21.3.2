...
! ------------------------------
      ...
      epg = 1.0 - es0 - esx*Cos(aesx*Pi*xt) - esy*Cos(aesy*Pi*yt) - &
      ...
      case(8)
      !tgsrc!
      !epg included in the diffusion term - AV 2017
        mms_source = -(kg*epg*(-(aTgx**2*Pi**2*Tgx*Cos(aTgx*Pi*xt)) - &
