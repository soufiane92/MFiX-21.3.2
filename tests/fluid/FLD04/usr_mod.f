...
!  Purpose: Function to return gresho problem initial conditions.       !
!                                                                      !
!  Reference:                                                          !
!                                                                      !
...
!                                                                      !
!  Author: Aniruddha Choudhary                        Date: Jun 2015   !
!  Purpose: Function to return gresho problem initial conditions for Ug !
!                                                                      !
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^!
...
!                                                                      !
!  Author: Aniruddha Choudhary                        Date: Jun 2015   !
!  Purpose: Function to return gresho problem initial conditions for Vg !
!                                                                      !
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^!
