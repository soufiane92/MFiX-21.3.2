...
class Numerics(object):
    ...
    def set_tmax_limits(self):
        tmin = self.project.get_value('tmin', default=250)
    ...
    def numerics_setup_advanced_tab(self):
        ...
        #Specify drag under-relaxation factor
        ...
        for item in (ui.label_ur_f_gs, ui.lineedit_keyword_ur_f_gs):
            ...
            if not enabled:
                ...
                item.setToolTip(item.toolTip()+"<br>&bull;Only available for TFM solver.")

        #Specify IA theory conductivity under-relaxation factor
