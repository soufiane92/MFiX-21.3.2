MODULE SOLVE_K_EPSILON_EQ_MOD
   ...
   use fldvar, only: k_turb_g, k_turb_go, k_turb_g
   ...
   use param, only: dimension_bc, dimension_3, dimension_m
   use param1, only: zero, one
   use residual, only: num_resid, den_resid
   use residual, only: resid, max_resid, ijk_resid, resid_ke
...
END MODULE SOLVE_K_EPSILON_EQ_MOD
