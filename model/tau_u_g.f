MODULE CALC_TAU_U_G_MOD

   USE bc
   USE cutcell
   USE fldvar, only: ep_g, u_g, v_g, w_g
   USE fun_avg, only: avg_x, avg_x_h, avg_y_h, avg_z_h
   ...
   USE visc_g, only: df_gu, trd_g, mu_gt, epmu_gt, lambda_gt, eplambda_gt
...
!$omp         axy_u, axz_u, ayz, ayz_u, vol_u, dil_ep_s,               &
...
!$omp         oneodx_e_u, oneodx_e_v, oneodx_e_w, dil_ep_s,            &
