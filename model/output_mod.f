...
! Flag to report solids inventory
      LOGICAL :: REPORT_SOLID_INVENTORY
! Interval at which solid inventory is reported.
      DOUBLE PRECISION :: REPORT_SOLID_INVENTORY_DT
! Flag to report solids inventory by phase
      LOGICAL :: BREAKDOWN_SOLID_INVENTORY_BY_PHASE
...
! Time at which solid inventory is reported.
      DOUBLE PRECISION :: SOLID_INVENTORY_TIME
