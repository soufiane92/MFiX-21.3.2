MODULE SOURCE_V_G_MOD

   USE bc
   USE bodyforce, only: bfy_g
   USE cg_source_v_g_mod, only: cg_source_v_g, cg_source_v_g_bc
   USE compar, only: ijkstart3, ijkend3, imap
   USE cutcell, only: a_vpg_s, a_vpg_n
   ...
   USE fldvar, only: v_g, w_g, v_go, u_s, v_s, w_s, v_so
