...
MODULE transport_prop_mod

   use calc_dif_g_mod, only: calc_dif_g
   use calc_dif_s_mod, only: calc_dif_s
   use calc_k_g_mod, only: calc_k_g
   use calc_k_s_mod, only: calc_k_s
   use calc_mu_g_mod, only: calc_mu_g
   use calc_mu_s_mod, only: calc_mu_s
   use error_manager
