...
MODULE check
   ...
   use fldvar, only: rop_g, rop_s, x_g, x_s
   use functions, only: funijk, fluid_at, is_on_mype_owns, is_on_mype_wobnd
   ...
   use output, only: report_mass_balance_dt
   ...
   use rxns, only: sum_r_g, sum_r_s, rox_gc, rox_sc, r_gp, r_sp
