...
! Modules
!-----------------------------------------------
    USE compar, ONLY: IJKSTART3, IJKEND3, nlayers_bicgs
...
!$omp    parallel do default(none) private(ijk,im1jk,ip1jk,ijm1k,ijp1k,ijkm1,ijkp1) &
!$omp                shared(avar,a_m,var,do_k,ijkstart3,ijkend3 )
...
! do nothing or no preconditioning
    if (use_doloop) then   ! default=false
