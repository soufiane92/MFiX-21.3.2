...
! Cell Aspect ratio
      ...
      DOUBLE PRECISION,  DIMENSION(:), ALLOCATABLE ::  Aspect_ratio_U
      DOUBLE PRECISION,  DIMENSION(:), ALLOCATABLE ::  Aspect_ratio_V
      DOUBLE PRECISION,  DIMENSION(:), ALLOCATABLE ::  Aspect_ratio_W
      END MODULE geometry
