MODULE SOURCE_V_S_MOD

   use bc
   use bodyforce, only: bfy_s
   use calc_gr_boundary, only: calc_grbdry
   use cg_source_v_s_mod, only: cg_source_v_s, cg_source_v_s_bc
   use compar
   use constant
   use cutcell
   use drag
   ...
   use mms, only: use_mms, mms_v_s_src
