MODULE CALC_TAU_W_G_MOD

   USE bc
   USE cutcell
   USE fldvar, only: ep_g, u_g, v_g, w_g
   USE fun_avg, only: avg_z, avg_x_h, avg_y_h, avg_z_h
   ...
   USE visc_g, only: df_gw, trd_g, epmu_gt, mu_gt, lambda_gt, eplambda_gt
...
!$omp         axy,  axy_w, ayz_w, axz_w, vol_w, dil_ep_s,              &
...
!$omp         oneodz_t_u, oneodz_t_v, oneodz_t_w, dil_ep_s,            &
