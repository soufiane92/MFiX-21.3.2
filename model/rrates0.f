...
!                                                                      C
!  Revision Number: 1                                                  C
!  Purpose:Replaced routines with new procedures for automated         C
...
! Index/loop counters
      ...
      INTEGER :: lN     ! reaction species index
...
! the following 2 lines could be replaced by assigning lmmax=smax
...
! Complete the skew-symmetric for enthalpy transfer with mass transfer
               DO M=1, lMMAX
                   DO L=0, M-1
                    r_RxH(M,L) = - r_RxH(L,M)
                  ENDDO
