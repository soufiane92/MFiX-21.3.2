...
! The number ODEs (maximum).
      ...
      IF(.NOT.ALLOCATED(ODE_VARS_o)) allocate( ODE_VARS_o(lODE_DIMN) )
...
! State value returned from ODEPACK
...
! The number ODEs (maximum).
      ...
      write (mype_c, *) mype
      lFile = 'StiffChem_' // strip(mype_c) // '.log'
      ...
      WRITE(OEL_Unit,9001) IJK, I_OF(IJK), J_OF(IJK), K_OF(IJK), myPE
 ...
 9001 FORMAT(//5x,'Fluid Cell: ',I8,4x,'(',I4,',',I4,',',I4,')',10x,&
         'Process: ',I4)
