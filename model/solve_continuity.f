...
MODULE cont
   ...
   use calc_resid_mod, only: calc_resid_c
   use compar, only: ijkstart3, ijkend3
   use conv_rop_g_mod, only: conv_rop_g
   use conv_rop_s_mod, only: conv_rop_s
   ...
   use residual, only: resid, max_resid, ijk_resid, resid_ro
   use solve_lin_eq_mod, only: solve_lin_eq
   use source_rop_g_mod, only: source_rop_g
   use source_rop_s_mod, only: source_rop_s, point_source_rop_s
