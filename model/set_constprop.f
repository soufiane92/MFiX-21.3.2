...
!-----------------------------------------------
      ...
      USE run, only: ks_model_enum, ks_consteff, ks_none
...
! Strictly fluid cells: FLAG = 1
               ...
               IF (KS_MODEL_ENUM(M) == KS_NONE .OR. &
                   KS_MODEL_ENUM(M) == KS_CONSTEFF) THEN 
