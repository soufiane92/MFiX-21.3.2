MODULE CONV_DIF_PHI_MOD
   ...
   USE functions, only: east_of, north_of, top_of, west_of, south_of, bottom_of
   ...
   USE param, only: bottom, east, north, south, top, west, dimension_is
