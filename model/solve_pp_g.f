...
! and use this to form normalization factor
        CALL CALC_RESID_PP (B_MMAX, ONE, NUM_RESID(RESID_P,0), &
         ...
         IJK_RESID(RESID_P,0))
         NORMGloc = RESID(RESID_P,0)/PPG_DEN
      ENDIF
