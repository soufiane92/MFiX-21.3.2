...
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
      ...
      SUBROUTINE  GHD_MODEL (S, SIGMAI,IJK, alpha, MI, phii, T, Zeta0, &
         ...
         use bulk_viscosity_mod, only: bulk_viscosity
         use chi_ij_ghd_mod, only: chi_ij_ghd
         use cooling_rate_mod, only: ludcmp, lubksb, cooling_rate
         use cooling_rate_tc_mod, only: cooling_rate_tc
         use drag
         use dufour_coeff_mod, only: dufour_coeff
         use mass_mobility_mod, only: mass_mobility
         use ordinary_diff_mod, only: ordinary_diff
         use pressure_mod, only: pressure
         use shear_viscosity_mod, only: shear_viscosity
         use thermal_conductivity_mod, only: thermal_conductivity
         use thermal_diffusivity_mod, only: thermal_diffusivity
         use thermal_mobility_mod, only: thermal_mobility
