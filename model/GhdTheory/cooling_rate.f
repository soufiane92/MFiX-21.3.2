...
!     Numerical Recipes in Fortran 77, page 374
!
...
!  Purpose: computes values of functions and Jacobians of homogeneous
...
!
!  Literature/Document References:
!     Numerical Recipes in Fortran 77, page 38-39
!
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
!
...
!
!  Literature/Document References:
!     Numerical Recipes in Fortran 77, page 39.
!
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
