...
MODULE k_epsilon_prop_mod

   use error_manager
   use calc_trd_g_mod, only: get_face_vel_gas, calc_deriv_vel_gas
...
!  Purpose: Calculate diffusion coefficient and sources for K &        C
!           Epsilon equations                                          C
!                                                                      C
!  Author:                                       Date:                 C
...
! This IF statement is to ensure that we are using the turbulent viscosity
