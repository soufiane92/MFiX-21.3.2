...
!                                                                      C
!  Module name: OUT_BIN_512L                                           C
!  Purpose: write out an array in chunks of 512 bytes (LOGICAL WORDS)  C
!                                                                      C
...
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^C
!
      SUBROUTINE OUT_BIN_512L(IUNIT, ARRAY, N, NEXT_REC)
