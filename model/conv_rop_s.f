MODULE CONV_ROP_S_MOD
   ...
   USE param, only: dimension_3, dimension_m, top, bottom, east, west, north, south
   USE param1, only: one
...
! volume fraction would then be corrected based on the value of
