...
!    database or the input deck. Species specific heats are needed by  !
...
!      can be achieved by simply entering the data as indicated by     !
!      the user guide.                                                 !
...
!       lambda_g = -2/3mu_g                                            !
!  - Value represents dynamic viscosity with dimension as:             !
!    mass/(length.time)                                                !
!                                                                      !
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^!
...
!                                                                      !
!  Comments:                                                           !
!  - Value represents thermal conductivity with dimension as:          !
...
!                                                                      !
!  Comments:                                                           !
!  - Value represents mass diffusivity with dimension as:              !
!    length^2/(time)                                                   !
!                                                                      !
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^!
...
!    in that format from the input deck. therefore inconsitencies      C
