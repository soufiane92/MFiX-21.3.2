...
! present at a specific boundary condition in proportion to their
...
! Logical keyword that can be set to TRUE to force the inlet
...
! solids time step).
      DOUBLE PRECISION, DIMENSION(:), ALLOCATABLE :: PI_FACTOR   !(DES_BCMI)
