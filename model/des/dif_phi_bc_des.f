MODULE DIF_PHI_BC_DES_MOD

   USE bc
   USE compar
   USE cutcell, only: CARTESIAN_GRID, CG_SAFE_MODE, blocked_cell_at, cut_cell_at, bc_id
   USE functions
   USE geometry
   USE indices, only: i_of, j_of, k_of, im1, jm1, km1
   USE param, only: dimension_3, dimension_m, bottom, top, east, west, north, south
