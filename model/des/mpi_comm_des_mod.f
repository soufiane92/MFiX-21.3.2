...
!                    debug - for printing debug statements
!------------------------------------------------------------------------
...
! Parameters       :
!                    parray - array to be written
!                    ploc2glb - this flag is used to convert local particle
