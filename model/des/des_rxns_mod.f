...
! Indicates that reactions rates are saved in output arrays for vtp or monitor files
      LOGICAL :: SAVE_PART_RRATES
! Reaction rates arrays for vtp or monitor files
      DOUBLE PRECISION, DIMENSION(:, :), ALLOCATABLE :: Part_RRates_out
