...
!$omp        des_vel_new, mppic, p_force,          &
!$omp        u_g,v_g,w_g,model_b,pvol,fc,f_gp,ep_g, optflag1)           &
...
!$omp shared(ncells_valid_pinc,valid_fluid_indices,start_index,end_index)
