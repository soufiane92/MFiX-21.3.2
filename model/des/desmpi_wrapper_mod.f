...
!------------------------------------------------------------------------
      subroutine des_mpi_irecv_db(precvbuf,precvcnt,ptoproc,preq,perr)
      implicit none
! dummy variables
      double precision, dimension(:) :: precvbuf
      integer :: precvcnt,ptoproc,preq,perr
#ifdef MPI
      call mpi_irecv(precvbuf,precvcnt,mpi_double_precision,ptoproc,0,mpi_comm_world,preq,perr)
#endif
      return
      end subroutine
...
!------------------------------------------------------------------------
      subroutine des_mpi_isend_db(psendbuf,psendcnt,ptoproc,preq,perr)
      implicit none
! dummy variables
      double precision, dimension(:) :: psendbuf
      integer :: psendcnt,ptoproc,preq,perr
#ifdef MPI
      call mpi_isend(psendbuf,psendcnt,mpi_double_precision,ptoproc,0,mpi_comm_world,preq,perr)
#endif
      return
      end subroutine
