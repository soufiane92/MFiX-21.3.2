MODULE CALC_DES_2FLUID_MOD
   ...
   USE RXNS, ONLY: R_GP, R_PHASE, ROX_GC, SUM_R_G
...
! Calculate gas phase source terms: gas-solids mass transfer
         IF(ANY_SPECIES_EQ) THEN
            IF(.NOT.STIFF_CHEMISTRY) CALL RXNS_GS_GAS1
         ENDIF
      ENDIF
...
END MODULE CALC_DES_2FLUID_MOD
