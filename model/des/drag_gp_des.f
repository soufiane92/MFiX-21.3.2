...
! determine the drag coefficient
      ...
      CASE (GAO)
         CALL DRAG_GAO(DgA,EPg,Mu,ROg,VREL,DPM,ROd,IJK)

      CASE (SARKAR)
         CALL DRAG_SARKAR(DgA,EPg,Mu,ROg,VREL,DPM,ROd,IJK)

      CASE (RADL)
         CALL DRAG_RADL(DgA,EPg,Mu,ROg,VREL,DPM,ROd,IJK)
