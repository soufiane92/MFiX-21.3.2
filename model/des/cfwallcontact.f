...
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
   ...
   SUBROUTINE CFWALLCONTACT(WALL, L, WALLCONTACT)
      ...
      USE discretelement, only: des_pos_new, des_radius, by1, ex2, nz2, sz1, ty2, wx1, des_le_bc
      USE discretelement, only: wall_vdw_outer_cutoff, des_periodic_walls, des_periodic_walls_x, des_periodic_walls_y, des_periodic_walls_z
