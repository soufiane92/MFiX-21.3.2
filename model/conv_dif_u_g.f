...
MODULE CONV_DIF_U_G_Mod
   ...
   USE functions, only: flow_at_e, south_of, bottom_of, wall_at
   USE geometry, only: ayz_u, axz_u, axy_u
   USE geometry, only: odx, ody_n, odz_t
   USE geometry, only: ox_e, do_k
   ...
   USE run, only: def_cor, discretize, momentum_x_eq
