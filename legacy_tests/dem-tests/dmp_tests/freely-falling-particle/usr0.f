...
! Brute force assignment of particle global ID to match order in particle_input.dat
      do lc1 = 1,pip
         if(compare(des_pos_new(lc1,1),30.0D0).and.compare(des_pos_new(lc1,3),30.0D0)) iglobal_id(lc1) = 1
         if(compare(des_pos_new(lc1,1),30.0D0).and.compare(des_pos_new(lc1,3),90.0D0)) iglobal_id(lc1) = 2
         if(compare(des_pos_new(lc1,1),90.0D0).and.compare(des_pos_new(lc1,3),30.0D0)) iglobal_id(lc1) = 3
         if(compare(des_pos_new(lc1,1),90.0D0).and.compare(des_pos_new(lc1,3),90.0D0)) iglobal_id(lc1) = 4
      enddo
